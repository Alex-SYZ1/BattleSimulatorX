...
class Cell:
    ...
    def __init__(self, 
                 ...
                 army_obj:Union[Amry,None] = None,
                 occupier:int = Constants.Cell.occupier):
        """_summary_

        Args:
            coordinate (tuple[int,int]): 坐标：横坐标和纵坐标数字元组
            boundaries_type (dict[int:int], optional): _description_. Defaults to Constants.Cell.boundaries_type.
            cell_type (int, optional): _description_. Defaults to Constants.Cell.cell_type.
            army_obj (Union[Amry,None], optional): _description_. Defaults to None.
            occupier (int, optional): _description_. Defaults to Constants.Cell.occupier.
        """
