...
class Cell:
    ...
    def __init__(self, 
        ...
        Args:
            ...
            army_obj (Union[Amry,None], optional): 驻扎军队对象. Defaults to None.
            occupier (int, optional): 占领者：分为红方占领、蓝方占领、无人占领. Defaults to Constants.Cell.occupier.
        """
        ...
        self.boundaries_type = boundaries_type  # 边界类型：分为河流和普通边界
