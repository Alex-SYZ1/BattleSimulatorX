...
class Cell:
    ...
    def get_adjacent_cells(self, circle_number):
        ...
        if circle_number == 1:
            ...
            adjacent2_cell_dict = {adj_index:(ajd_c if check_adj_by_border(ajd_c) else None) for adj_index,ajd_c in enumerate(get_adj_by_change(self.coordinate,(Constants.BoardCst.ODD_δx12 if c_x)),1)}
        else:
