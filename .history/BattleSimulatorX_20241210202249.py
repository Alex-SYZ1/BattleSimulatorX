...
class Cell:
    ...
    def get_adjacent_cells(self, circle_number):
        ...
        if circle_number == 1:
            ...
            if self.coordinate[0]%2 == 1:
                adjacent_cell_dict = {adj_index:ajd_c for adj_index,ajd_c in enumerate(get_adj_by_change(self.coordinate,[(0,1),(1,1),(1,0),(0,-1),(-1,0),(-1,1)]),1)}
