...
class Cell:
    __slots__ = ('coordinate', 'adjacent_cells', 'bordering_cells', 'boundary_type', 'cell_type')
    def __init__(self, coordinate, boundaries_type = {}, cell_type = 0, occupier = 0):
        """_summary_

        Args:
            coordinate (_type_): _description_
            boundary_type (int, optional): _description_. Defaults to 0.
            cell_type (int, optional): _description_. Defaults to 0.
            occupier (int, optional): _description_. Defaults to 0.
        """
